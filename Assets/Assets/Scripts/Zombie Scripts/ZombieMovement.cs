...
public class ZombieMovement : MonoBehaviour
{
    ...
    public void Move(Transform targetTransform){
       ...
       transform.position = Vector3.MoveTowards(transform.position, new Vector3(targetTransform.position.x , targetTransform.position.y - 0.9f , 0f), moveSpeed * Time.deltaTime);
    }
